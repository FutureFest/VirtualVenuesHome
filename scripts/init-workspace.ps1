...
function Ensure-AgentsDelegate([string]$WorkspacePath) {
  ...
  if (Test-Path -LiteralPath $agentsPath) {
    ...
    if ($forceAgents) {
      ...
      Write-WarnLine "Root AGENTS.md is a generated delegate; do not edit it directly."
      Write-WarnLine "Update VirtualVenuesHome/AGENTS.md and init-workspace script templates."
